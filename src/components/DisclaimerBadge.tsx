...
export default function DisclaimerBadge() {
  ...
  return (
    <>
      ...
      <div data-disclaimer-badge className="fixed top-16 inset-x-0 z-40 bg-emerald-50/90 dark:bg-emerald-900/60 border-b border-emerald-200 dark:border-emerald-700">
        <button
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 w-full max-w-lg rounded-2xl bg-emerald-100 dark:bg-neutral-900 border border-emerald-200 dark:border-emerald-800/40 shadow-2xl flex flex-col max-h-[80vh]"
            >
              {/* Header — fixed */}
