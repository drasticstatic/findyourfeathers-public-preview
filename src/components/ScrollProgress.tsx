...
export default function ScrollProgress() {
  ...
  return (
    <motion.button
      ...
      onClick={scrollToTop}
      className="fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full bg-emerald-200 dark:bg-neutral-900 border border-emerald-300 dark:border-emerald-800/40 shadow-lg hover:shadow-xl transition-shadow group"
