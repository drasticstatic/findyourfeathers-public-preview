...
export default function DisclaimerBadge() {
  ...
  return (
    <>
      ...
      <div data-disclaimer-badge className="fixed top-16 inset-x-0 z-40 bg-emerald-100/85 backdrop-blur-md dark:bg-emerald-950/80 border-b border-emerald-200 dark:border-emerald-800/40">
        <button
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 w-full max-w-lg rounded-2xl bg-emerald-100/90 backdrop-blur-md dark:bg-neutral-900 border border-emerald-200 dark:border-emerald-800/40 shadow-2xl flex flex-col max-h-[80vh]"
            >
              {/* Header — fixed */}
                ...
                <div className="space-y-5 text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      the official website of Find Your Feathers.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      environment — exploring how an AI-powered guide
                      could serve a personal healing and transformation
                      community.
                    </p>
